...
namespace ngen::memory {
    Heap::Heap()
            : m_rootBlock(nullptr), m_memoryBlock(nullptr), m_allocationStrategy(kAllocationStrategy::Invalid),
              m_heapLength(0), m_allocations(0), m_totalAllocations(0), m_failedAllocations(0) {
